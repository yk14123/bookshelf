...
/**
 * An interaction behavior plugin for a child view of {@link android.support.design.widget.CoordinatorLayout} to make it work as
 * a bottom sheet.
 *
 * 重写BottomSheetBehavior 扩展底部的拖动状态
 * fork from https://www.jianshu.com/p/9cecfabd6118;
 */
public class BottomViewDragBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
     ...
     */
    public BottomViewDragBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
...
//            }
    ...
    /**
     * A utility function to get the {@link BottomViewDragBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link BottomViewDragBehavior}.
     * @return The {@link BottomViewDragBehavior} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> BottomViewDragBehavior<V> from(V view) {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof BottomViewDragBehavior)) {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomSheetBehavior");
        }
        return (BottomViewDragBehavior<V>) behavior;
    }
