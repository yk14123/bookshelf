...
//        int realHeight = 0;
//        try {
//            Method mt = outMetrics.getClass().getMethod("getRealSize", Point.class);
//            mt.setAccessible(true);
//            realHeight = (int) mt.invoke(outMetrics, size);
//            LogUtil.i("size -> " + size);
...
//            Method mt = null;
//            try {
//                mt = outMetrics.getClass().getMethod("getRawHeight");
//            } catch (NoSuchMethodException e2) {
//                e2.printStackTrace();
//                LogUtil.i("e2 -> " + e2);
//                try {
//                    mt = outMetrics.getClass().getMethod("getRealHeight");
...
//                try {
//                    mt.setAccessible(true);
//                    realHeight = (int) mt.invoke(outMetrics);
//                } catch (Exception e4) {
//                    e4.printStackTrace();
//                    LogUtil.i("e4 -> " + e4);
//                }
...
//            LogUtil.i("e -> " + e);
//        }
//        LogUtil.i("realHeight -> " + realHeight);
    }
